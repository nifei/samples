...
const WCHAR* GetResDir()
{
	...
	PathAppend(wszModulePath, L"..\\..\\samples\\LuaClass\\XAR");
                     ...
                     int       nCmdShow)
{
    ...
    LuaBase::RegisterClass(hEnv);
	LuaDerived1::RegisterClass(hEnv);
	LuaDerived2::RegisterClass(hEnv);
    LuaFactory::RegisterObj(hEnv);
